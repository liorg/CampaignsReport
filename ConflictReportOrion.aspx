<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConflictReportOrion.aspx.cs"
    Inherits="Report.UI.GridReport.ConflictReportOrion" %>

<%@ Register TagPrefix="hs" TagName="HeaderSorting" Src="~/Controls/C2013Orion/Grid/HeaderSorting2013.ascx" %>
<%@ Register TagPrefix="sb" TagName="StatusBar" Src="~/Controls/C2013Orion/Grid/StatusBar.ascx" %>
<%@ Register TagPrefix="das" TagName="DataAreaSorting" Src="~/Controls/C2013Orion/Grid/DataAreaSorting.ascx" %>
<%@ Register TagPrefix="bb" TagName="RefreshButton2013" Src="~/Controls/C2013Orion/Grid/RefreshButton2013.ascx" %>
<%@ Register TagPrefix="jb" TagName="JumpBar" Src="~/Controls/C2013Orion/Grid/JumpBar.ascx" %>
<!DOCTYPE html>
<html>
<head>
    ...
    <link href="/crm2013/OrionStyle2013/1033/fonts.css" rel="stylesheet" type="text/css" />
    <link href="/crm2013/OrionStyle2013/1033/global.css" rel="stylesheet" type="text/css" />
    <link href="/crm2013/OrionStyle2013/1033/theme.css" rel="stylesheet" type="text/css" />
    <link href="/crm2013/OrionStyle2013/1033/controls.css" rel="stylesheet" type="text/css" />
    <link href="/crm2013/OrionStyle2013/1033/select.css" rel="stylesheet" type="text/css" />
    <link href="/crm2013/OrionStyle2013/1033/menu.css" rel="stylesheet" type="text/css" />
    <link href="/crm2013/OrionStyle2013/1033/CompositeControl.css" rel="stylesheet" type="text/css" />
    <link href="/crm2013/OrionStyle2013/1033/appgrid.css" rel="stylesheet" type="text/css" />
    <script src="scripts/ConflictReport.js" type="text/javascript"></script>
</head>
<body class="stage">
                                        ...
                                        <div class="ms-crm-grid-body" style="bottom: 25px;">
                                            <div class="ms-crm-IE7-Height-Fix-Dummy-Container">
                                                <div style="height: 100%; position: relative" id="crmGrid_gridBodyContainer">
                                                    <span id="gridbuttons" class="ms-crm-GridButtons">
<div id="filterButton" class="ms-crm-List-FilterButton">
<a id="filterButtonLink" tabIndex="0" href="#"><img style="margin-top: 2px; margin-right: 2px; margin-left: 2px; cursor: pointer;" id="filterButtonImage" class="ms-crm-ImageStrip-grid_filter" title="Filter" alt="Filter"
 src="/_imgsorion/imagestrips/transparent_spacer.gif?ver=533615464"></a></div>
