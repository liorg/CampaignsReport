<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StatusBar.ascx.cs" Inherits="CampaignsReport.StatusBar" %>
            ...
            <tbody>
                <tr>
                    <td id="crmGrid_RecordSelectInfo" class="ms-crm-List-StatusBar-Label" nowrap>
                        <span id="crmGrid_FirstItem"><%= CurrentPaging.ToString() %></span> - <span id="crmGrid_LastItem"><%= MaxPaging.ToString() %></span><span
                            style="display: inline" id="crmGrid_TotalCountInfo">&nbsp;of <span id="crmGrid_ItemsTotal">
                                <%= CurrentDataCount.ToString() %></span></span><span id="crmGrid_ItemsSelectedInfo">&nbsp;(<span id="crmGrid_ItemsSelected">1</span>
                    ...
                    <td id="crmGrid_PageInfo" class="ms-crm-List-Paging" nowrap>
                        <a style="cursor: auto" id="fastRewind" class="toolbarbutton" disabled tabindex="0"
                            ...
                            <img id="page_FL0" class="ms-crm-ImageStrip-page_FL0" alt="" align="absMiddle" src="/_imgs/imagestrips/transparent_spacer.gif"
                                temptooltip="Load First Page"></a>  <asp:LinkButton ID="LinkButton1" CssClass="toolbarbutton" OnClick="NextPage_Click" CommandName="prev"
                            runat="server">
                                    <img id="page_L0" class="ms-crm-ImageStrip-page_L1" disabled hspace="6" alt="" align="absMiddle"
                        ...
                        <asp:LinkButton ID="lnkNextPage" CssClass="toolbarbutton" OnClick="NextPage_Click" CommandName="next"
                            runat="server"><img id="page_R0" class="ms-crm-ImageStrip-page_R1" hspace="6" alt="Load Next Page"  align="absMiddle" src="/_imgs/imagestrips/transparent_spacer.gif" temptooltip="Load Next Page"></asp:LinkButton>
                    </td>
                </tr>
            </tbody>
        </table>
