        ...
        <tr style="height: 20px">
            <asp:Repeater runat="server" ID="repCols" OnItemCommand="repCols_ItemCommand" OnItemDataBound="repCols_ItemDataBound">
                ...
                <ItemTemplate>
                    ...
                    <td>
                        <img class="ms-crm-List-ResizeBar ms-crm-ImageStrip-resize" alt="" id="<%# GetCrmGridResizeId(Eval("FieldSchemaName"))  %>" src="/_imgs/imagestrips/transparent_spacer.gif">
                    </td>
                </ItemTemplate>
                <FooterTemplate>
                </FooterTemplate>
            ...
            <td>
                <img alt="" crmgrid="crmGrid" class="ms-crm-List-ResizeBar ms-crm-ImageStrip-resize"
                    src="/_imgs/imagestrips/transparent_spacer2013.gif?ver=-1057465603">
            </td>
            <td></td>
        </tr>
    </tbody>
