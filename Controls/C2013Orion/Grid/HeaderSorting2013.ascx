    ...
    <asp:Repeater runat="server" ID="repWidth">
        <HeaderTemplate>
            <colgroup id="crmGrid_gridBarCols">
                <col class="ms-crm-List-NonDataColumnHeader" name="<%# Eval("FieldSchemaName") %>" width="32">
                <col width="2">
        </HeaderTemplate>
        <ItemTemplate>
        ...
        <tr style="height: 20px">
            <asp:Repeater runat="server" ID="repCols" OnItemCommand="repCols_ItemCommand" OnItemDataBound="repCols_ItemDataBound">
                <HeaderTemplate>
                    ...
                    <td>
                        <img id="bar_line" src="/_imgsOrion/imagestrips/transparent_spacer2013.gif" class="ms-crm-ImageStrip-bar_line"
                            alt="">
                    </td>
                </HeaderTemplate>
                <ItemTemplate>
                    <th scope="col"
                        field="<%# Eval("FieldSchemaName")  %>"
                        fieldname="<%# Eval("FieldSchemaName") %>"
                        entityname="customentityname" renderertype="Crm.PrimaryField"
                        class="ms-crm-List-Sortable" displaylabel="<%# Eval("Title")%>">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ms-crm-List-Sortable">
                                       ...
                                       <asp:Image ImageUrl ="/_imgsOrion/imagestrips/transparent_spacer2013.gif"  ID="imgSortType" runat="server" CssClass="ms-crm-ImageStrip-dropdown" /></nobr>
                                        </asp:LinkButton>
                                    </td>
                                                ...
                                                <td nowrap align="left">
                                                    <ul class="ms-crm-MenuBar-Left" style="margin-top: 0px">
                                                        <li class="ms-crm-FilterPopupMenu" tabindex="-1" menu="mnustringFilterPopupcrmGridaccountname"
                                                            id="<%# GetFilterPopupcrmGridId(Eval("FieldSchemaName"))  %> "
                                                            attributexml="&lt;attributeinfo&gt;&lt;result&#32;value=&quot;name&quot;&#32;datatype=&quot;nvarchar&quot;&#32;maxlength=&#39;160&#39;&gt;Account&#32;Name&lt;/result&gt;&lt;lookupicons&gt;&lt;/lookupicons&gt;&lt;/attributeinfo&gt;"
                                                            relationshipname="" isfromfiltermenu="true" isfromrelatedentity="False" filtermenutype="string"
                                                            gridid="crmGrid" attributetype="nvarchar"
                                                            attributename="<%# Eval("FieldSchemaName") %>"
                                                            columnname="<%# Eval("FieldSchemaName") %>"
                                                            entityname="customentityname" attributeformat="text" xml_filter="&lt;Menu&#32;title=&quot;StringFilterPopupMenu&quot;&#32;menuId=&quot;stringFilterPopupcrmGridaccountname&quot;&gt;&lt;MenuItem&#32;id=&quot;_MIcrmGridaccountnameResetFilter&quot;&#32;type=&quot;ResetFilter&quot;&#32;display=&quot;Reset&#32;Filter&quot;&#32;isenabled=&quot;True&quot;&#32;iconPath=&quot;/_imgsOrion/grid/disablereset.png&quot;&#32;/&gt;&lt;MenuItem&#32;type=&quot;space&quot;&#32;display=&quot;spacer&quot;&#32;/&gt;&lt;MenuItem&#32;id=&quot;_MIcrmGridaccountnameSortAsc&quot;&#32;type=&quot;SortAsc&quot;&#32;display=&quot;Sort&#32;A&#32;to&#32;Z&quot;&#32;isenabled=&quot;True&quot;&#32;iconPath=&quot;/_imgsOrion/grid/asc.png&quot;&#32;/&gt;&lt;MenuItem&#32;id=&quot;_MIcrmGridaccountnameSortDesc&quot;&#32;type=&quot;SortDesc&quot;&#32;display=&quot;Sort&#32;Z&#32;to&#32;A&quot;&#32;isenabled=&quot;True&quot;&#32;iconPath=&quot;/_imgsOrion/grid/desc.png&quot;&#32;/&gt;&lt;MenuItem&#32;type=&quot;space&quot;&#32;display=&quot;spacer&quot;&#32;/&gt;&lt;MenuItem&#32;id=&quot;_MIcrmGridaccountnameIsNotNull&quot;&#32;type=&quot;IsNotNull&quot;&#32;display=&quot;Contains&#32;Data&quot;&#32;isenabled=&quot;True&quot;&#32;iconPath=&quot;/_imgsOrion/imagestrips/transparent_spacer2013.gif&quot;&#32;/&gt;&lt;MenuItem&#32;id=&quot;_MIcrmGridaccountnameIsNull&quot;&#32;type=&quot;IsNull&quot;&#32;display=&quot;Contains&#32;No&#32;Data&quot;&#32;isenabled=&quot;True&quot;&#32;iconPath=&quot;/_imgsOrion/imagestrips/transparent_spacer2013.gif&quot;&#32;/&gt;&lt;MenuItem&#32;type=&quot;space&quot;&#32;display=&quot;spacer&quot;&#32;/&gt;&lt;MenuItem&#32;id=&quot;_MIcrmGridaccountnameCustomFilters&quot;&#32;type=&quot;CustomFilters&quot;&#32;display=&quot;Custom&#32;Filter...&quot;&#32;isenabled=&quot;True&quot;&#32;iconPath=&quot;/_imgsOrion/imagestrips/transparent_spacer2013.gif&quot;&#32;/&gt;&lt;/Menu&gt;">
                                                            <div class="ms-crm-FilterPopupMenu-Label">
                                                                <a href="javascript:void(0)" class="ms-crm-FilterPopupMenu-Label" tabindex="0">
                                                                    <div class="ms-crm-Menu-FilterImgWrapper">
                                                                        <img src="/_imgsOrion/imagestrips/transparent_spacer2013.gif?ver=-1057465603" alt="" id="mnuDown"
                    ...
                    <td>
                        <img class="ms-crm-List-ResizeBar ms-crm-ImageStrip-resize" alt="" id="<%# GetCrmGridResizeId(Eval("FieldSchemaName"))  %>" src="/_imgsOrion/imagestrips/transparent_spacer.gif">
                    </td>
                </ItemTemplate>
                <FooterTemplate>
                </FooterTemplate>
            ...
            <td>
                <img alt="" crmgrid="crmGrid" class="ms-crm-List-ResizeBar ms-crm-ImageStrip-resize"
                    src="/_imgsOrion/imagestrips/transparent_spacer2013.gif?ver=-1057465603">
            </td>
            <td></td>
        </tr>
    </tbody>
